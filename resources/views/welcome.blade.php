          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse sub-menu-bar" id="navbarNine">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="page-scroll" href="#packs">Packs</a>
                  </li>
                <li class="nav-item">
            ...
            <div class="navbar-btn d-none d-lg-inline-block">
              <a class="btn rounded primary-btn-reversed" href="#">S'inscrire</a>
              <a class="btn text-white" href="#">Connexion</a>
            </div>
          </nav>
          <!-- navbar -->
        </div>
            ...
            <div class="about-five-tab">
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-who" role="tabpanel" aria-labelledby="nav-who-tab">
                  <p>Freedom Beauty est une société créée à Agadir en 2022, qui fabrique et vend des produits cosmétiques et nutritionnels de bonne qualité, par des experts de la nutrition et de la cosmétique</p>
                </div>
                <div class="tab-pane fade" id="nav-vision" role="tabpanel" aria-labelledby="nav-vision-tab">
                  <p>Faouzi El Briky est le fondateur et le directeur géneral de Freedom Beauty , aussi il est Coach en développement personnel , a 13 ans d'expérience dans le domaine du marketing digitale </p>
